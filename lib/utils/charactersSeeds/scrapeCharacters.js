...
const nonCharacterLinks = require('./nonCharacterLinks.json.js');

const scrapeCharacterInfo = () => {
  return request.get('https://steven-universe.fandom.com/wiki/Category:Characters')
...
module.exports = scrapeCharacterInfo;
